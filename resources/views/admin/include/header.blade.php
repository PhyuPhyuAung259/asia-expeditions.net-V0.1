      ...
      <ul class="nav navbar-nav">
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="/storage/avata/thumbnail/{{Auth::user()->picture}}" class="user-image">
          ...
          <ul class="dropdown-menu">           
            ...
            <li class="user-footer">
              <div class="pull-left">
                <a href="{{route('userStore', ['id'=> Auth::user()->id])}}" class="btn btn-default btn-flat">Edit Profile</a>
              </div>
